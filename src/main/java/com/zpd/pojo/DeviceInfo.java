...
public class DeviceInfo implements Serializable {
    ...
    public void setApkServerVersion(String apkServerVersion) {
        this.apkServerVersion = apkServerVersion == null ? null : apkServerVersion.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getEsn() == null ? other.getEsn() == null : this.getEsn().equals(other.getEsn()))
            && (this.getMac() == null ? other.getMac() == null : this.getMac().equals(other.getMac()))
            && (this.getStatus() == null ? other.getStatus() == null : this.getStatus().equals(other.getStatus()))
            && (this.getType() == null ? other.getType() == null : this.getType().equals(other.getType()))
            && (this.getOpenAt() == null ? other.getOpenAt() == null : this.getOpenAt().equals(other.getOpenAt()))
            && (this.getCloseAt() == null ? other.getCloseAt() == null : this.getCloseAt().equals(other.getCloseAt()))
            ...
            && (this.getNetState() == null ? other.getNetState() == null : this.getNetState().equals(other.getNetState()))
            && (this.getWlanIp() == null ? other.getWlanIp() == null : this.getWlanIp().equals(other.getWlanIp()))
            && (this.getVersion() == null ? other.getVersion() == null : this.getVersion().equals(other.getVersion()))
            && (this.getApkVersion() == null ? other.getApkVersion() == null : this.getApkVersion().equals(other.getApkVersion()))
            && (this.getApkServerVersion() == null ? other.getApkServerVersion() == null : this.getApkServerVersion().equals(other.getApkServerVersion()))
            && (this.getMonitorSno() == null ? other.getMonitorSno() == null : this.getMonitorSno().equals(other.getMonitorSno()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEsn() == null) ? 0 : getEsn().hashCode());
        result = prime * result + ((getMac() == null) ? 0 : getMac().hashCode());
        result = prime * result + ((getStatus() == null) ? 0 : getStatus().hashCode());
        result = prime * result + ((getType() == null) ? 0 : getType().hashCode());
        result = prime * result + ((getOpenAt() == null) ? 0 : getOpenAt().hashCode());
        result = prime * result + ((getCloseAt() == null) ? 0 : getCloseAt().hashCode());
        result = prime * result + ((getMain() == null) ? 0 : getMain().hashCode());
        result = prime * result + ((getSceneId() == null) ? 0 : getSceneId().hashCode());
        result = prime * result + ((getNetState() == null) ? 0 : getNetState().hashCode());
        result = prime * result + ((getWlanIp() == null) ? 0 : getWlanIp().hashCode());
        result = prime * result + ((getVersion() == null) ? 0 : getVersion().hashCode());
        result = prime * result + ((getApkVersion() == null) ? 0 : getApkVersion().hashCode());
        result = prime * result + ((getApkServerVersion() == null) ? 0 : getApkServerVersion().hashCode());
        result = prime * result + ((getMonitorSno() == null) ? 0 : getMonitorSno().hashCode());
